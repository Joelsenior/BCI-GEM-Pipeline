function [hobj,h] = PlotHybridHdcaClassifier(fwdModel, v, chanlocs, vtimes_ms)
...
for i=1:nBins % for each time bin
    subplot(4,nCols,rem(i-1,2)*nCols+floor((i-1)/2)+1);
...
%h = MakeFigureTitle('Forward Models (Mean Across Folds) (uV)',0);
